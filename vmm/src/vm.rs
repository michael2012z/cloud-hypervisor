...
impl Vm {
    ...
    pub fn boot(&mut self) -> Result<()> {
        ...
        //
        // The commented code below illustrates why we have to separate
        // VCPU's creation and activation into 2 stages to cover aarch64.
        // (It will be de-commented when supporting code is ready.)
        //
        // On aarch64, VCPU's have to be created in prior of GIC.
        //
        // #[cfg(target_arch = "aarch64")]
        // let boot_vcpus = self.cpu_manager.lock().unwrap().boot_vcpus();
        //
        ...
        // On aarch64, configure_system() is impossible until VCPU's and GIC
        // created. Because configure_system() will also create FDT which
        // requires information of VCPU's and GIC.
        #[cfg(target_arch = "aarch64")]
