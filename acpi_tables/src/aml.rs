...
mod tests {
    ...
    #[test]
    fn test_uuid() {
        let data = [17, 19, 10, 16, 120, 86, 52, 18, 52, 18, 120, 86, 18, 52, 18, 52, 86, 120, 18, 52];
        assert_eq!(
            Uuid::new("12345678-1234-5678-1234-123456781234".to_string()).to_aml_bytes(),
            &data[..]
        );
    }
}
